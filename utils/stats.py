...
async def main():
    ...
    print("Users\n"
          ...
          f"Global sizes, ND: {total_nd_file_size}, D: {total_d_file_size}\n"
          f"Weekly sizes, ND: {total_nd_file_size_week}, "
          f"D: {total_d_file_size_week}\n"
          f"Biggest file: {biggest_file['filename']} at "
          f"{biggest_file['file_size']/1024/1024:.1f}MiB\n\n"
          "Shortens\n"
          "========\n"
